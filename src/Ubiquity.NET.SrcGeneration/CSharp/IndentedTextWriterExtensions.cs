...
namespace Ubiquity.NET.SrcGeneration.CSharp
{
    ...
    public static class IndentedTextWriterExtensions
    {
        ...
        public static void WriteAutoGeneratedComment( this IndentedTextWriter self, string toolName, string toolVersion, string? source = null, bool writeClosingNewLine = false )
        {
