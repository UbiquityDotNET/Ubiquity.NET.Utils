...
namespace Ubiquity.NET.CodeAnalysis.Utils
{
        ...
        where T : IEquatable<T>
    {
        ...
        /// <param name="value">Value of the result (may be <see langword="null"/> to indicate no results)</param>
        ...
        /// </remarks>
        /// <exception cref="ArgumentException">Both <paramref name="value"/> and <paramref name="diagnostics"/> are <see langword="null"/> or empty</exception>
