...
namespace Ubiquity.NET.SourceGenerator.Test.Utils
{
        ...
        where TGenerator : IIncrementalGenerator
    {
        ...
        /// <summary>Adds a resource file name as key with a hint name and <see cref="SourceText"/> as the contents</summary>
        /// <param name="resourceName">Name of the manifest resource [Key]</param>
