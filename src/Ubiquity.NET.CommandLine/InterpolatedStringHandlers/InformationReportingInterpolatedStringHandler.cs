...
{
    /// <summary>Interpolated string handler for an <see cref="IDiagnosticReporter"/> using a fixed <see cref="MessageLevel.Information"/></summary>
    /// <remarks>
    ...
    {
        /// <summary>Initializes a new instance of the <see cref="InformationReportingInterpolatedStringHandler"/> struct.</summary>
        ...
        {
            Builder = reporter.IsEnabled( MessageLevel.Information ) ? new( literalLength ) : null;
        }
        ...
        /// <see cref="MessageLevel.Information"/> level is enabled for a given reporter.
        /// </remarks>
