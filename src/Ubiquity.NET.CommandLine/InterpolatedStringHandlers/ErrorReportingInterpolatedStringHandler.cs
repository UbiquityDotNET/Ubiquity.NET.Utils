...
{
    /// <summary>Interpolated string handler for an <see cref="IDiagnosticReporter"/> using a fixed <see cref="MessageLevel.Error"/></summary>
    /// <remarks>
    ...
    public readonly struct ErrorReportingInterpolatedStringHandler
    {
        ...
        {
            Builder = reporter.IsEnabled( MessageLevel.Error ) ? new( literalLength ) : null;
        }
        ...
        /// <see cref="MessageLevel.Error"/> level is enabled for a given reporter.
        /// </remarks>
