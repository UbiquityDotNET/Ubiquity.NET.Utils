...
{
    /// <summary>Interpolated string handler for an <see cref="IDiagnosticReporter"/> using a fixed <see cref="MessageLevel.Verbose"/></summary>
    /// <remarks>
    ...
    public readonly struct VerboseReportingInterpolatedStringHandler
    {
        ...
        {
            Builder = reporter.IsEnabled( MessageLevel.Verbose ) ? new( literalLength ) : null;
        }
        ...
        /// <see cref="MessageLevel.Verbose"/> level is enabled for a given reporter.
        /// </remarks>
