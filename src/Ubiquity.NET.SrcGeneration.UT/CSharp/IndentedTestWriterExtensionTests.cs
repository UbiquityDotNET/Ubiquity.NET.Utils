...
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
        ...
        public void WriteAutoGeneratedComment_succeeds( )
        {
           const string expected = """
            ...
            Assert.AreEqual(expected, writer.ToString());
                ...
                [TestMethod]
        public void WriteAutoGeneratedComment_with_closing_newline_succeeds( )
        {
           const string expected = """
            // ------------------------------------------------------------------------------
            // <auto-generated>
            ...
            using var writer = new OwningIndentedStringWriter();
            writer.WriteAutoGeneratedComment("MyTool", "1.2.3.4", writeClosingNewLine: true);
            Assert.AreEqual(expected, writer.ToString());
        }
        ...
        [TestMethod]
        public void WriteAutoGeneratedComment_with_source_with_closing_newline_succeeds( )
        {
            const string expected = """
            // ------------------------------------------------------------------------------
            // <auto-generated>
            ...
            using var writer = new OwningIndentedStringWriter();
            writer.WriteAutoGeneratedComment( "MyTool", "1.2.3.4", @"C:\SomeDir\MyFile.cs", writeClosingNewLine: true );
            Assert.AreEqual( expected, writer.ToString() );
        }
        ...
        [TestMethod]
        public void WriteAutoGeneratedCommentBlock_with_closing_newline_succeeds( )
        {
            const string expected = """
            // ------------------------------------------------------------------------------
            // <auto-generated>
            ...
            using var writer = new OwningIndentedStringWriter();
            using(writer.WriteAutoGeneratedCommentBlock( "MyTool", "1.2.3.4", writeClosingNewLine: true ))
            {
                writer.WriteLine("//");
                writer.WriteLine("//     This is a test");
                writer.WriteLine("//");
        ...
        [TestMethod]
        public void Namespace_with_closing_newline_succeeds( )
        {
            const string expected = """
            namespace My.Namespace
            {
            ...
            using var writer = new OwningIndentedStringWriter();
            using(writer.Namespace( "My.Namespace", writeClosingNewLine: true ))
            {
                writer.WriteLine( "// This is a test..." );
            }
        ...
        [TestMethod]
        public void Struct_with_closing_newline_succeeds( )
        {
            const string expected = """
            public partial struct MyStruct
            {
            ...
            using var writer = new OwningIndentedStringWriter();
            using(writer.Struct("public partial", "MyStruct", writeClosingNewLine: true ))
            {
                writer.WriteLine( "// This is a test..." );
            }
        ...
        [TestMethod]
        public void UnsafeScope_with_closing_newline_succeeds( )
        {
            const string expected = """
            unsafe
            {
            ...
            using var writer = new OwningIndentedStringWriter();
            using(writer.UnsafeScope(writeClosingNewLine: true))
            {
                writer.WriteLine( "// This is a test..." );
            }
        ...
        [TestMethod]
        public void Scope_with_leading_and_closing_newline_succeeds( )
        {
            const string expected = """
            // C# scope
            {
            ...
            using var writer = new OwningIndentedStringWriter();
            using(writer.Scope( "// C# scope", writeClosingNewLine: true ))
            {
                writer.WriteLine( "// This is a test..." );
            }
        ...
        [TestMethod]
        public void Scope_without_leading_and_closing_newline_succeeds( )
        {
            const string expected = """
            {
                // This is a test...
            ...
            using var writer = new OwningIndentedStringWriter();
            using(writer.Scope( writeClosingNewLine: true))
            {
                writer.WriteLine( "// This is a test..." );
            }
        ...
        [TestMethod]
        public void MultiLineComment_with_null_or_empty_text_and_closing_newline_is_nop( )
        {
            using var writer = new OwningIndentedStringWriter();
            writer.MultiLineComment(null, writeClosingNewLine: true );
            Assert.AreEqual(0, ((StringWriter)writer.InnerWriter).GetStringBuilder().Length);

            writer.MultiLineComment( string.Empty, writeClosingNewLine: true );
            Assert.AreEqual( 0, ((StringWriter)writer.InnerWriter).GetStringBuilder().Length );

            writer.MultiLineComment( " \t ", writeClosingNewLine: true );
            Assert.AreEqual( 0, ((StringWriter)writer.InnerWriter).GetStringBuilder().Length );
        }
        ...
        [TestMethod]
        public void MultiLineComment_with_closing_newline_succeeds( )
        {
            const string expected = """
            /*
                This is a test...
            ...
            */
            ...
            using var writer = new OwningIndentedStringWriter();
            writer.MultiLineComment( string.Join(Environment.NewLine, ["This is a test...", "of a multi-line comment"] ), writeClosingNewLine: true);
        ...
        [TestMethod]
        public void Class_with_clsing_newline_succeeds( )
        {
            const string expected = """
            public partial class MyClass
            {
            ...
            using var writer = new OwningIndentedStringWriter();
            using(writer.Class( "public partial", "MyClass", writeClosingNewLine: true ))
            {
                writer.WriteLine( "// This is a test..." );
            }
