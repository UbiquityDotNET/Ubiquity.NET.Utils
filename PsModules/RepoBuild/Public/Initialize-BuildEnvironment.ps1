...
.DESCRIPTION
    ...
    | Name                       | Description                              |
    |----------------------------|------------------------------------------|
    | OfficialGitRemoteUrl       | GIT Remote URL for official source of ***this*** repository (NOT a fork of it) |
#>
    ...
    try
    {
        ...
        $buildInfo['OfficialGitRemoteUrl'] = 'https://github.com/UbiquityDotNET/Ubiquity.NET.Utils.git'
