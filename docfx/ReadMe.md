...
3) Accept that the in editor rendering might "trim" the lines it shows, eliminating any
   indentation. [Grrr... Looking at you VS!]
    a) Sadly, there is no avoiding this for some editors. Addition of any sort of "markup"
       to control that will interfere with the readability AND the final docs rendering.
