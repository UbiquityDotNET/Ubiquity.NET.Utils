# Ubiquity.NET.Utils
Ubiquity.NET.Utils family of libraries provides support for a number of scenarios. They originally began as helpers
for the LLVM or AOT generation for embedded devices but grew to enough functionality to warrant their own repository
and versioning.
...
| [Ubiquity.NET.CodeAnalysis.Utils](CodeAnalysis/index.md) | This library contains extensions and helpers for using Roslyn CodeAnalysis |
